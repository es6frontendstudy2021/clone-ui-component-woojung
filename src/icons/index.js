...
export const SpinDot = `
  <sapn class="ant-spin-dot ant-spin-dot-spin">
...
export const EyeInvisible = `
  <span role="img" aria-label="eye-invisible" class="anticon anticon-eye-invisible">
...
export const Eye = `
  <span role="img" aria-label="eye-invisible" class="anticon anticon-eye">
    <svg viewBox="64 64 896 896" focusable="false" data-icon="eye-invisible" width="1em" height="1em" fill="currentColor" aria-hidden="true">
